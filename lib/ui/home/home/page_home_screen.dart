    ...
    if (_controller.buttonChipTypeSelected.value == StringConstants.placeTop) {
      ...
      return Expanded(
        child: ListView.separated(
          ...
          itemCount: _controller.listLocation.length,
          itemBuilder: (BuildContext context, int index) {
            return _getRowListPlaceTop(_controller.listLocation[index], index);
          },
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                if (index == 0)
                  Image.asset(
                      width: 30, height: 30, "assets/images/ic_crown.png"),
                widgetTopPlace,
                const SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(trip.isPublic == true ? Icons.public : Icons.lock,
                      color: Colors.grey),
