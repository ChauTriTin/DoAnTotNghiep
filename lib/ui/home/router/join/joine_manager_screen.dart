...
class _JoinedManagerScreenState extends State<JoinedManagerScreen> {
  ...
  Widget getListMembers() {
    if (_controller.members.isEmpty) {
      return Container(
        margin: const EdgeInsets.symmetric(horizontal: DimenConstants.marginPaddingMedium, vertical: DimenConstants.marginPaddingSmall),
        child: Column(
          children: [
      ...
      child: Center(
        child: Row(
          children: [
            ...
            Expanded(child: Container(margin: const EdgeInsets.only(left: DimenConstants.marginPaddingMedium, right: DimenConstants.marginPaddingMedium), child: Text(user.name ?? ""))),
            getIconUser(user),
          ],
        ),
      ),
  ...
  Widget getIconUser(UserData user) {
    if (user.uid == UserSingletonController.instance.getUid()) {
      return Container(
        width: 40,
        height: 40,
