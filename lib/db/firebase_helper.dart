...
class FirebaseHelper {
  ...
  static String keyNotification = "notification";
  ...
  static final CollectionReference collectionReferenceNotification =
  FirebaseFirestore.instance.collection(keyNotification);
}
